          ...
          <div className="md:col-span-7 lg:col-span-8 space-y-4">
            ...
            <div className="flex items-center gap-3 pt-1">
              <a
                ...
                className="action-btn inline-block px-4 py-2.5 text-xs font-bold text-white bg-blue-600 hover:bg-blue-700 rounded-lg transition-colors cursor-pointer shadow-md shadow-blue-600/25"
              >

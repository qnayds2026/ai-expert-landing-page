        ...
        <div className="bg-gradient-to-br from-slate-50 via-white to-blue-50/40 rounded-3xl border border-blue-100/90 shadow-xl overflow-hidden p-6 sm:p-8 lg:p-10">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
            ...
            <div className="lg:col-span-5 flex flex-col items-center justify-center">
              <div className="relative group w-full max-w-[360px] sm:max-w-[420px] lg:max-w-[460px]">
                {/* Decorative border backdrop */}
                <div className="absolute -inset-1 bg-gradient-to-r from-blue-600 to-indigo-600 rounded-3xl blur-sm opacity-25 group-hover:opacity-50 transition duration-300" />
                
                <div className="relative rounded-2xl overflow-hidden bg-white border-2 border-white shadow-2xl">
                  <img
                    src={sawadImg}
                    alt="Sawad KT - Founder Qnayds LLP"
                    className="w-full h-auto object-cover max-h-[520px] mx-auto block transform group-hover:scale-[1.02] transition-transform duration-300"
                  />
                  <div className="absolute bottom-0 inset-x-0 bg-gradient-to-t from-slate-950/85 via-slate-950/45 to-transparent p-5 text-white text-center">
                    <p className="font-extrabold text-xl leading-tight text-white">Sawad KT</p>
                    <p className="text-xs sm:text-sm text-blue-200 font-medium mt-0.5">Founder – Qnayds LLP</p>
                  </div>
                </div>
              </div>
            </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
                  <div className="p-4 rounded-xl bg-white border border-blue-100 shadow-2xs space-y-1.5 flex items-start gap-3">
                    ...
                    <div>
                      <p className="text-sm font-bold text-slate-900 leading-snug">
                        Educated 1 Million+ Learners
                      </p>
                      <p className="text-xs text-slate-600 font-normal">
                        Educated 1 Million+ learners via social media.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="p-4 rounded-xl bg-white border border-blue-100 shadow-2xs space-y-1.5 flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-slate-600 font-normal">
                        Helped multiple businesses scale via AI & Automation.
                      </p>
                    </div>
                  </div>
                </div>

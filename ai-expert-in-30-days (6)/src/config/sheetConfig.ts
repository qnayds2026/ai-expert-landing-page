...
// Razorpay Test / Live Configuration (₹1)
...
export const RAZORPAY_PAYMENT_URL: string = "https://rzp.io/l/ai-masterclass-1rs";

// Masterclass Pricing Configuration (₹1 Offer / ₹999 Regular)
export const PAYMENT_AMOUNT_INR = 1; // ₹1 token fee
export const ORIGINAL_PRICE_INR = 999; // Crossed-out original price
export const DISCOUNT_PERCENT = 99; // 99% OFF

...
export const PricingSection: React.FC<PricingSectionProps> = ({ onOpenEnrollment }) => {
  ...
  const includedFeatures = [
    { title: '30-Day Training', desc: 'Comprehensive step-by-step practical AI workflow curriculum' },
    { title: 'Live Sessions', desc: 'Interactive live workshops with real-time screen sharing and Q&A' },
    { title: 'LMS Access', desc: '24/7 access to all recorded sessions, templates, and downloadable resource kits' },
    { title: 'WhatsApp Mentoring', desc: 'Dedicated private WhatsApp group for daily homework reviews and mentor guidance' },
    { title: 'Practical Projects', desc: 'Build 12 real-world portfolio deliverables and launch your capstone business' }
  ];
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-2xl mx-auto space-y-3">
          ...
          <p className="text-slate-600 text-sm sm:text-base leading-relaxed font-normal">
            Gain immediate access to full live training, course recordings, resources, and hands-on project mentoring.
          </p>
        </div>
        ...
        <div className="mt-10 sm:mt-12 bg-white rounded-3xl border-2 border-blue-500 shadow-xl shadow-blue-500/10 overflow-hidden relative">
          ...
          <div className="bg-blue-600 py-2 text-center text-white text-xs font-bold uppercase tracking-wider flex items-center justify-center gap-2">
            ...
            <span>Special Invitation • 100% Free Live Access</span>
            <Sparkles className="w-3.5 h-3.5 text-blue-200" />
          </div>

          <div className="p-6 sm:p-10 lg:p-12 space-y-8">
            
            {/* Price Display with Strikethrough (5000 vetti) */}
            <div className="flex flex-col sm:flex-row sm:items-baseline justify-between gap-4 pb-6 border-b border-slate-100">
              ...
              <div className="text-left sm:text-right">
                ...
                <p className="text-xs text-slate-500 font-medium mt-0.5">
                  No payment required • Limited batch access
                </p>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <h4 className="text-xs font-bold uppercase tracking-wider text-slate-900">
                Everything Included In Your Free Access:
              </h4>
